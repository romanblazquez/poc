    ...
    <>
      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto scrollbar-thin">
              ...
              {channels.map((ch) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isActive && (
                      <span className="text-xs font-bold" style={{ color: ch.displayMetadata.color }}>✓ Active</span>
                    )}
                  </button>
                );
              })}
          ...
          {/* Inspector — only when on a channel */}
          {currentChannel && (
            <>
              {/* Channel info */}
              <div
                className="flex items-center gap-3 border-b px-4 py-3"
                style={{ borderBottomColor: `${channelColor}40` }}
              >
