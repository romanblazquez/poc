...
import { FundsAllocationsComponent } from './components/funds-allocations/funds-allocations.component';

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [FundsAllocationsComponent],
  template: `<app-funds-allocations [theme]="theme"></app-funds-allocations>`,
})
