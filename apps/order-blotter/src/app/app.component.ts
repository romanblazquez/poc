...
import { OrderBlotterComponent } from './components/order-blotter/order-blotter.component';

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [OrderBlotterComponent],
  template: `<app-order-blotter [theme]="theme"></app-order-blotter>`,
})
